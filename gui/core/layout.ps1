...
function Get-NetworkDiagGuiControlNames {
    return @(
        ...
        "AdvancedFilter","AdvancedShowNonDefault","AdvancedBundleSelector","ApplyAdvancedBundle","UndoApplyAdvanced",
        "ResetAdvancedAll","ResetAdvancedTiming","ResetAdvancedSwitches","ResetAdvancedPathMtu","ResetAdvancedUdp","ResetAdvancedLongTcp","ResetAdvancedCapture",
        "CopyAdvancedSnippet","PasteAdvancedSnippet","AdvancedValidationStatus","AdvancedPreviewCliCommand","AdvancedExportCliCommand",
